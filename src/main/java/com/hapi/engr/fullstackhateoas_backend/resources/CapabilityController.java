package com.hapi.engr.fullstackhateoas_backend.resources;


import com.hapi.engr.fullstackhateoas_backend.domain.Capability;
import com.hapi.engr.fullstackhateoas_backend.services.CapabilityService;
...
public class CapabilityController {
    ...
    @PutMapping("/{id}")
    public Object updateCapability(@PathVariable Long id,
